package com.womai.shop.services.kuaidi;


import com.womai.common.tool.util.HttpClientUtil;

import com.womai.shop.domain.front.Kuaidi100Info;
...
public class kuaidi100Helper {
	...
	public static Kuaidi100Info selectKuaidi100(){
		try {
            String url ="http://api.kuaidi100.com/api?id=7fdd7136ff90ef2d&com=yunda&nu=1201205716323&valicode=&show=0&muti=1&order=desc";
            String response = HttpClientUtil.httpReader(url, "UTF-8");
//			String response = HttpUtil.get(url,null,"UTF-8");
...
//			logger.error(info.getData().toString());
	...
	public static void main(String[] agrs) throws Exception{
		...
		if(1==2){
            String response = HttpClientUtil.httpReader("http://127.0.0.1:8080/myshopFront/kuaidi100JSON.jsp", "UTF-8");
