package com.womai.shop.services.oscache;
...
import com.womai.shop.manage.FrontContainer;
import com.womai.shop.services.KeyValueHelper;
import com.womai.shop.services.ManageContainer;
import com.womai.shop.manage.front.SystemManager;
import com.womai.shop.services.pay.alipay.alipayescow.config.AlipayConfig;
import com.womai.shop.manage.util.DateTimeUtil;
import com.womai.shop.manage.front.AdvertService;
import com.womai.shop.domain.front.Advert;
import com.womai.shop.manage.front.AreaService;
import com.womai.shop.domain.front.Area;
import com.womai.shop.manage.front.AttributeService;
import com.womai.shop.domain.front.Attribute;
import com.womai.shop.manage.front.CatalogService;
import com.womai.shop.domain.front.Catalog;
import com.womai.shop.manage.front.CommentService;
import com.womai.shop.manage.front.CommentTypeService;
import com.womai.shop.domain.front.CommentType;
import com.womai.shop.manage.front.ExpressService;
import com.womai.shop.domain.front.Express;
import com.womai.shop.manage.front.IndexImgService;
import com.womai.shop.domain.front.IndexImg;
import com.womai.shop.manage.front.KeyvalueService;
import com.womai.shop.domain.front.Keyvalue;
import com.womai.shop.manage.front.NavigationService;
import com.womai.shop.domain.front.Navigation;
import com.womai.shop.manage.front.NewsService;
import com.womai.shop.domain.front.News;
import com.womai.shop.manage.front.NotifyTemplateService;
import com.womai.shop.domain.front.NotifyTemplate;
import com.womai.shop.manage.front.OrderService;
import com.womai.shop.manage.front.PayService;
import com.womai.shop.domain.front.Pay;
...
import com.womai.shop.manage.front.SystemSettingService;
import com.womai.shop.domain.front.SystemSetting;
import com.womai.shop.manage.admin.AccountRankService;
import com.womai.shop.domain.admin.AccountRank;
import com.womai.shop.manage.admin.ActivityService;
import com.womai.shop.domain.admin.Activity;
import com.womai.shop.manage.admin.HotqueryService;
import com.womai.shop.domain.admin.Hotquery;
...
//            File file = new File(path + "__area.json");
            String filePath = getClass().getClassLoader().getResource("__area.json").getPath();
...
//		p.setFinalPrice(String.valueOf(p.caclFinalPrice()));
        String finalPrice = productService.caclFinalPrice(p);
        p.setFinalPrice(String.valueOf(finalPrice));
