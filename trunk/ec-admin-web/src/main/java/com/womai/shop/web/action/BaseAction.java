package com.womai.shop.web.action;
...
import com.womai.common.tool.util.StringParse;
...
public abstract class BaseAction<E extends PagerModel> extends ActionSupport
    ...
    public Long getPassportId(){
        return StringParse.parseLong((String) getRequest().getAttribute("X-Passport-UserId"));
    }

    public String getPassportName(){
        return (String) (getRequest().getAttribute("X-Passport-UserName"));
    }

    public int getPassportType(){
        return StringParse.parseInt((String) getRequest().getAttribute("X-Passport-UserType"));
    }
