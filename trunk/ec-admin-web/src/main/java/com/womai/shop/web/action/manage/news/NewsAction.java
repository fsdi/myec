 ...
 * jqsl2012@163.com
 */
package com.womai.shop.web.action.manage.news;

import com.womai.shop.domain.page.PagerModel;
import com.womai.shop.manage.admin.CatalogService;
import com.womai.shop.manage.admin.IndexImgService;
import com.womai.shop.manage.admin.NewsService;
...
//		getE().setCreateAccount(user.getUsername());
        ...
        getE().setCreateAccount( super.getPassportName());
