...
<%@page import="com.womai.shop.web.action.manage.account.AccountAction"%>
<%@page import="org.slf4j.LoggerFactory"%>
<%@page import="org.slf4j.Logger"%>
<%@page import="com.womai.shop.manage.front.AccountService"%>
<%@page
	import="org.springframework.web.context.support.WebApplicationContextUtils"%>
<%@page import="org.springframework.web.context.WebApplicationContext"%>
<%@page import="com.womai.shop.manage.front.SystemManager"%>
<%@page import="com.womai.shop.domain.front.LoginTypeEnum"%>
<%@page import="com.womai.shop.domain.front.Account"%>
<%@page import="com.womai.shop.services.ManageContainer"%>
<%@page import="com.womai.shop.services.pay.alipay.alipayescow.util.AlipayNotify"%>
<%
	/* *
	 功能：支付宝页面跳转同步通知页面
	 版本：3.2
