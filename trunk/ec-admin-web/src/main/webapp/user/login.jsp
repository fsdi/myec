				...
				<div class="panel panel-success" style="width:500px;">
		              ...
		              <%--<div class="panel-footer" id="otherLogin">--%>
		              	<%--<a href="<%=request.getContextPath() %>/user/qqLogin.html">--%>
		              		<%--<img src="<%=request.getContextPath() %>/resource/images/qqLogin.png">--%>
		              	<%--</a>--%>
		              	<%--<a  href="<%=request.getContextPath() %>/user/sinawb.html">--%>
		              		<%--<img src="<%=request.getContextPath() %>/resource/images/sinawbLogin.png">--%>
		              	<%--</a>--%>
...
<%--&lt;%&ndash; 						<span id="wb_connect_btn" title="使用新浪微博号登陆"></span> &ndash;%&gt;--%>
	...
	<%--&lt;%&ndash; 							<img src="<%=SystemManager.systemSetting.getWww() %>/resource/images/alipay.gif" alt="支付宝快捷登陆"> &ndash;%&gt;--%>
								<%--<img src="<%=request.getContextPath() %>/resource/images/alipay_fastlogin.jpg" alt="支付宝快捷登陆">--%>
							<%--</a>--%>
						<%--</span>--%>
		              <%--</div>--%>
	            </div>
